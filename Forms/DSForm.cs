...
namespace OrderManagerEF.Forms
{
    public partial class DSForm : RibbonForm
    {
        ...
        private async void barButtonItem12_ItemClick(object sender, ItemClickEventArgs e)
        {
            try
            {
        ...
        private void gridView1_KeyDown_Sort(object sender, KeyEventArgs e)
        {
            if (e.Shift && e.KeyCode == Keys.S)
            {
                // If Shift+S is pressed, perform the button click action
